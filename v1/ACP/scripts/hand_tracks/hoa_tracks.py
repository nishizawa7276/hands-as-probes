...
FLAGS = flags.FLAGS
flags.DEFINE_string('out_dir', '/data01/mohit/Track-Hands/output/partitioned_tracks', '')
flags.DEFINE_string('data_dir', 
                    # "/home/mohit/EPIC-KITCHENS", 'Path to EPIC-KITCHENS frames')
                    "/home/knishizawa/EPIC-KITCHENS", 'Path to EPIC-KITCHENS frames')
...
flags.DEFINE_string('hoa_dir',
                    ...
                    "/home/knishizawa/hands-as-probes/v1/ACP/detections_partitioned",
...
def crop_out_tracks(video_id, boxes):
    ...
    for _, box in enumerate(boxes):
        ...
        # print("video_id.split : " , video_id.split )
        # print("video_id : " , video_id )
        # print("frame_",  f"frame_{str(i + 1).zfill(10)}" )
        imgpath = f"{FLAGS.data_dir}/{video_id.split('_')[0]}/rgb_frames/{video_id}/frame_{str(i + 1).zfill(10)}.jpg"
        video_id_p_force = "P01"
        video_id_force = "P01_109"

        imgpath = f"{FLAGS.data_dir}/{video_id_p_force}/rgb_frames/{video_id_force}/frame_{str(i + 1).zfill(10)}.jpg"

        # print("Image.open(imgpath)" , imgpath )
...
def generate_tracks(side, typ, out_dir, video_id):
    ...
    for ind, track in enumerate(tracks):
        if track.shape[0] > 20:
            ...
            print("L217 file_name", file_name)
...
def main(_):
    ...
    for split in ["train", "validation"]:
        ...
        test_s1 = pd.read_csv("/home/knishizawa/hands-as-probes/v1/ACP/scripts/annotations/EPIC_test_s1_object_video_list.csv")
        # test_s2 = pd.read_csv("/data01/mohit/InteractionHotspots/original_split/EPIC_test_s2_object_video_list.csv")
        test_s2 = pd.read_csv("/home/knishizawa/hands-as-probes/v1/ACP/scripts/annotations/EPIC_test_s2_object_video_list.csv")
        ...
        all_videos = list(pd.read_csv("/home/knishizawa/hands-as-probes/v1/ACP/scripts/annotations/EPIC_55_annotations.csv")['video_id']) + to_be_removed_videos

        annotations = annotations[annotations['video_id'].isin(all_videos)]
        
        test_particips = ["P01", "P08", "P11", "P02", "P32", "P18", "P04", "P09", "P03"]
        print(f"Filtering p {test_particips}")

        annotations = annotations[~annotations['participant_id'].isin(test_particips)]
